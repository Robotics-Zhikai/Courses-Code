...
* 1. [实验](#1. 实验)
  *1.1 [非线性方程求解](#1.1 非线性方程求解)
  *1.2 [线性方程组的求解](#1.2 线性方程组的求解)
  *1.3 [龙格现象的产生和克服](#1.3 龙格现象的产生和克服)
  *1.4 [曲线拟合的最小二乘法](#1.4 曲线拟合的最小二乘法)
* 2. [期末复习总结](#2. 期末复习总结)
  * 2.0 [数学基础](#2.0 数学基础) 
  * 2.1 [非线性方程（组）的数值解法](#2.1 非线性方程（组）的数值解法) 
  * 2.2 [线性方程（组）的数值解法](#2.2 线性方程（组）的数值解法)
  * 2.3 [插值法与数值逼近](#2.3 插值法与数值逼近)
  * 2.4 [数值积分](#2.4 数值积分)
  * 2.5 [矩阵特征值与特征向量的计算](#2.5 矩阵特征值与特征向量的计算)
  * 2.6 [常微分方程数值解法](#2.6 常微分方程数值解法)
